...
import com.mindskip.iiacs.domain.ExamPaperAnswerInfo;
...
public interface ExamPaperAnswerService extends BaseService<ExamPaperAnswer> {
    ...
    PageInfo<ExamPaperAnswer> adminPage(com.mindskip.iiacs.viewmodel.admin.paper.ExamPaperAnswerPageRequestVM requestVM);
}
