...
import com.mindskip.iiacs.domain.Message;
...
import com.mindskip.iiacs.domain.enums.RoleEnum;
...
import com.mindskip.iiacs.viewmodel.student.user.*;
...
//        this.messageService = messageService;
    ...
    public RestResponse register(@RequestBody @Valid UserRegisterVM model) {
        ...
        userEventLog.setContent("欢迎 " + user.getUserName() + " 注册来到colligate exam system系统");
