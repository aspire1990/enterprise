...
import com.mindskip.iiacs.domain.other.ExamPaperAnswerUpdate;
import com.mindskip.iiacs.domain.task.TaskItemAnswerObject;
import com.mindskip.iiacs.repository.ExamPaperAnswerMapper;
import com.mindskip.iiacs.repository.ExamPaperMapper;
import com.mindskip.iiacs.repository.QuestionMapper;
import com.mindskip.iiacs.repository.TaskExamCustomerAnswerMapper;
...
public class ExamPaperAnswerServiceImpl extends BaseServiceImpl<ExamPaperAnswer> implements ExamPaperAnswerService {
    ...
    public ExamPaperAnswerInfo calculateExamPaperAnswer(ExamPaperSubmitVM examPaperSubmitVM, User user) {
        ...
        Integer pageIndex = examPaperSubmitVM.getPageIndex();
        ...
        String frameTextContent = textContentService.selectByFtcidPageIndex(examPaper.getFrameTextContentId(), pageIndex).getContent();
    ...
    @Override
    public PageInfo<ExamPaperAnswer> adminPage(com.mindskip.iiacs.viewmodel.admin.paper.ExamPaperAnswerPageRequestVM requestVM) {
        return PageHelper.startPage(requestVM.getPageIndex(), requestVM.getPageSize(), "id desc").doSelectPageInfo(() ->
